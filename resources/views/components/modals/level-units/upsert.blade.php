...
<div wire:ignore.self id="upsert-level-unit-modal" class="modal fade" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="upsert-level-unit-modal-title">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                @if (is_null($levelUnitId))
                <h5 id="upsert-level-unit-modal-title" class="modal-title">Add Level Unit</h5>
                @else
                <h5 id="upsert-level-unit-modal-title" class="modal-title">Update Level Unit</h5>
                @endif
