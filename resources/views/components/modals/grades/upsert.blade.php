...
<div wire:ignore.self id="upsert-grade-modal" class="modal fade" tabindex="-1" data-bs-backdrop="static"
    aria-labelledby="upsert-grade-modal-title">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                @if (is_null($gradeId))
                <h5 id="upsert-grade-modal-title" class="modal-title">Add Grade</h5>
                @else
                <h5 id="upsert-grade-modal-title" class="modal-title">Update Grade</h5>
                @endif
