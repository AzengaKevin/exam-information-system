    ...
    <div class="col-md-12">
        <div class="row g-3">
            ...
            <a href="{{ route('departments.index') }}"
                class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-decoration-none">
                <div class="bg-white shadow-sm card h-100 border-light">
                    <div class="card-body">
                        <div class="p-0 card-text">
                            <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('level-units.index') }}"
                class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-decoration-none">
                <div class="bg-white shadow-sm card h-100 border-light">
                    <div class="card-body">
                        <div class="p-0 card-text">
                        ...
                        <div class="p-0 card-text">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="fw-bold number-count">{{ \App\Models\Message::count() }}</span>
                                </div>
                                <div
                                    class="bg-primary bg-gradient w-4 h-4 rounded-circle d-inline-flex align-items-center justify-content-center">
